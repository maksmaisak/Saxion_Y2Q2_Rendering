...
local materials = {
    {
        shader = 'pbr',
        albedo = 'objects/decorations/Pillar/Texture/Pilars_AlbedoTransparency.png',
        metallicSmoothness = 'objects/decorations/Pillar/Texture/Pilars_MetallicSmoothness.png',
        ao = 'objects/decorations/Pillar/Texture/Pilars_AO.png',
...
local extras = {
    ...
    },
    {
        Name = "Pilars_tall",
        Transform = {
            position = {8.16, -0.05, 3.54},
            children = {
                {
                    Name = "Pilars_tall:Pilars",
                    Transform = {
                    },
                    RenderInfo = {
                        mesh = 'objects/decorations/Pillar/Pilars_tall.obj',
